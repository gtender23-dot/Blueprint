...
export const MANIFEST = [
  ...
  { name: 'saved_team_library_ui_smoke.mjs', tier: 'full', kind: 'pw', timeoutSec: 300, note: 'REWRITTEN 2026-08-17 (FULLGATE_TRIAGE item 8): the library half retargeted from the unreachable coach home to where saved teams surface now — Play Now\'s "Saved dynasty teams" source picker (listing, coach attachment, snapshot actually fields). Save-action checks unchanged. NOTE: saved-team DELETE has no reachable door anywhere (deleteSavedTeam wired only in the unreachable coach home) — product gap, owner decision owed (STATUS 2026-08-17). First LOCAL PW run owed.' },
  { name: 'instant_classic_ui_smoke.mjs', tier: 'full', kind: 'pw', timeoutSec: 300, note: 'REWRITTEN 2026-08-17 (FULLGATE_TRIAGE item 9): classics re-seeded onto a TREE (noteTreeMeta + treeWorldKey save) and driven via [data-mm-tree-classic]; replay-half assertions unchanged. Two real moves asserted as such: rows print Season not World (a tree has one world), and NO delete control exists on the tree path ([data-mm-classic-del] was coach-home-only) — product gap, owner decision owed (STATUS 2026-08-17). First LOCAL PW run owed.' },
