...
export { CONFERENCES, SCHOOL_DATA, WORLDGEN_INFO, applyIdentityToSchool, availableStates, buildDepthChart, buildRoleSortedDepthOrder, assembleWorldSources, compileLeague, defaultGameplan, generateAICoach, generateExhibitionTeam, generatePlayerProgram, generateRecruitPool, generateSchedule, generateWorld, hashStr, repairRecruitLocations };
